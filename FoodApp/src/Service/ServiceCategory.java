...
public class ServiceCategory {
    ...
    public void ajouter(Category c) throws SQLException {
        ...
        String requeteInsert = "INSERT INTO `food`.`category` (`id`, `name`, `text`, `color`) VALUES (NULL, '" + c.getName() + "' ,  '" 
        + c.getText() + "' , '" + c.getColor() + "');";
    ...
    public boolean update(String nom1, String nom2, String color, String Description) throws SQLException {
        PreparedStatement pre = con.prepareStatement("UPDATE category SET name= '" + nom2 + "' , color= '" + color + "' ,text= '" 
        + Description + "'  WHERE name='" + nom1 + "' ;");
