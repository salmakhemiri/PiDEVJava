...
if(verificationcolor && verificationdescription && verificationnom)
    {
        try {
...
// Fin updates 
    ...
    private void testdescription(KeyEvent event) {
         int nbNonChar = 0;
            ...
            if (nbNonChar == 0 && CatDesc.getText().trim().length() >=10) {
           
            erreurdescription.setText("Nom valide");
            
            verificationdescription = true;
            } else {
            
              erreurdescription.setText("Il faut au moins 10 caractères");
